...
module.exports=router.post('/createNewUserProfile',async(req, res)=>{
    ...
    if(!name || !email || !roll || !year || !section || !skills || !github || !phone){
        return res.status(404).json({ error: "Please filled the form properly"})
    }
    ...
    try {
        if(userExist){
            ...
            let transporter = nodemailer.createTransport({
                service:'gmail',
                auth: {
                    user: 'vrreddy97274@gmail.com', // generated ethereal user
                    pass: 'dspaxswlcpvazbkc', // generated ethereal password
                },
            });
 
            const msg={ 
                subject: "Verify Account",
                from: 'vrreddy97274@gmail.com', // sender address
                to: userEmail,  // Subject line
